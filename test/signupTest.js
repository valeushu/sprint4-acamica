...
describe('testing api auth login', () => {
    ...
    it('3.API login and me OK', async () => {
        ...
        assert.deepEqual(json.data.email, 'admin1@gmail.com', 'the email is expected admin1@gmail.com');
    });
    ...
    it('4.API login denied', async () => {
        ...
        assert.notDeepEqual(json.status, 'unauthorized', 'the status is expected: "unauthorized"'),
